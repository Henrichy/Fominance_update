    ...
    return (
        ...
        <div className="conta flex justify-center flex-col items-center">
            ...
            <div className={`flex pointer flex-col justify-center items-center bg-white shadow-lg rounded-md p-12 ${isGiftcardClicked ? 'bg-blue-100' : ''}`} onClick={handleGiftcardClick}>
                ...
                <div className="pointer flex flex-col justify-center items-center bg-white shadow-lg rounded-md p-12">
                    <img className="w-[200px] h-[150px]" src={Saly45} alt="" />
                    <h3 className="font-semibold">Ordering and Payment</h3>
                </div>
                <div className="flex flex-col justify-center items-center bg-white shadow-lg rounded-md p-12">
            ...
            <div className="w-[100%] flex flex-col justify-center items-center gap-4  my-8">
                ...
                {selectedCategory === 'giftcard' ? <FaqSectionGiftcard /> : null}
                {selectedCategory === 'acc' ? <FaqSectionAcc /> : null}
            </div>
        </div>
        <Supportcomp />
        <Footer/>
