  ...
  return (
    ...
    <div className=" bg-blue-600 py-14 px-10 flex Supportdiv  ">
      ...
      <div className='h-[398px] bg-white mr-auto w-[671px] p-[50px]'>
        ...
        <a href="/support/contact"> <button className='bg-btnBlue hover:shadow-xl transition ease-linear rounded-full text-white text-[20px] font-semi-bold w-[162px] h-[50px] mt-8'>
          Contact Us
        </button></a>
      </div>
    </div>
